...
\subsubsection[{pdvmax}]{\setlength{\rightskip}{0pt plus 5cm}int const {\bf pdvmax} (
...
\subsubsection[{taille\-Board}]{\setlength{\rightskip}{0pt plus 5cm}int const {\bf taille\-Board} (
\begin{DoxyParamCaption}
\item[{8}]{}
\end{DoxyParamCaption}
...
\subsubsection[{taille\-Main}]{\setlength{\rightskip}{0pt plus 5cm}int const {\bf taille\-Main} (
\begin{DoxyParamCaption}
\item[{8}]{}
\end{DoxyParamCaption}
