...
\subsubsection[{\-Demoniste}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Demoniste\-::\-Demoniste} (
...
\subsubsection[{$\sim$\-Demoniste}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Demoniste\-::$\sim$\-Demoniste} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
