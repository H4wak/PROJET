...
\subsubsection[{\-Guerrier}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Guerrier\-::\-Guerrier} (
...
\subsubsection[{$\sim$\-Guerrier}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Guerrier\-::$\sim$\-Guerrier} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
