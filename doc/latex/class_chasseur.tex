...
\subsubsection[{\-Chasseur}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Chasseur\-::\-Chasseur} (
...
\subsubsection[{$\sim$\-Chasseur}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Chasseur\-::$\sim$\-Chasseur} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
